...
# MAGIC
# MAGIC This notebooks gives a slightly complex example of using lambda in Databricks. For more information see this [article](https://www.bouvet.no/bouvet-deler/databricks-lambda).
# MAGIC
